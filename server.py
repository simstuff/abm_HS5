...
server = mesa.visualization.ModularServer(model_cls=TrustModel,visualization_elements=[wealth_chart,trust_chart,avg_gen_trust_chart,avg_ptrust_chart],name="MyModel",model_params=model_params ,port=8080)